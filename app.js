...
let movies = [
		{
			...
			"rating": 5,
			"age_rating": "PG-13",
			"synopsis": "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam sed purus euismod, faucibus orci vitae, cursus eros.",
...
app.post('/movie-control', (req, res) => {
  const {title, genre, release_date, runtime, rating, age_rating, synopsis, poster_image_url} = req.body
